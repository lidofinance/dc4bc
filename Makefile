...
build-darwin:
	...
	GOOS=darwin GOARCH=amd64 go build -o airgapped_state_cleaner ./cmd/airgapped_state_cleaner/
...
build-linux:
	...
	@echo "Building Airgapped state cleaner..."
	GOOS=linux GOARCH=amd64 go build -o airgapped_state_cleaner ./cmd/airgapped_state_cleaner/
