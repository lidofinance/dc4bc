...
type Client interface {
	...
	SetSkipMessageVerification(bool)
}
...
func (c *BaseClient) SetSkipMessageVerification(f bool) {
	c.skipMessageVerification = f
}
